...
def chat_api():
    ...
    # Your chat logic here, replacing what was done via gr.Interface
    # For demonstration, let's just echo the received data
    output_0 = f"Echo: {user_input}"
    output_1 = f"IDs: QID={qid}, UID={uid}"

    return jsonify({'output_0': output_0, 'output_1': output_1})
